...
const FAQ = () => {
    return (
        <>
            {/* FAQ */}
            <div id="faq" className="container" style={{ paddingTop: "5%" }}>
                <div className="row">
                            ...
                            >
                                <div className="accordion-body">
                                    <p>
                                        ...
                                        perspiciatis maiores dicta ratione error magnam accusamus facere
                                        incidunt eaque illum.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item" style={{ marginTop: 16 }}>
                            ...
                            >
                                <div className="accordion-body">
                                    <p>
                                        ...
                                        consequuntur animi magni quia minima ipsum eveniet, esse
                                        repellat dolores. Commodi!
                                    </p>
                                </div>
                            </div>
                        </div>
